...
def build_wiki_relation(market_name, connection_file, tic_wiki_file,
    ...
    np.save('/home/kikyo/data/qt/relation/wikidata/' + market_name + '_wiki_relation_fill', wiki_relation_embedding)
...
if __name__ == '__main__':
    ...
    build_wiki_relation('NASDAQ',
                        os.path.join(path, 'NASDAQ_connections_fill.json'),
                        os.path.join(path, 'NASDAQ_wiki_fill.csv'),
                        os.path.join(path, 'selected_wiki_connections.csv'))
    print('----------')
    build_wiki_relation('NYSE',
                        os.path.join(path, 'NYSE_connections_fill.json'),
                        os.path.join(path, 'NYSE_wiki_fill.csv'),
                        os.path.join(path, 'selected_wiki_connections.csv'))