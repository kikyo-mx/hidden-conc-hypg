...
# pre_config
device = 'cuda'
log_path = 'D:\\code\\hidden-conc-hypg\\log\\'
writer = SummaryWriter(log_path)
os.remove(log_path + os.listdir(log_path)[0])
market_name = 'NASDAQ'
data_path = 'D:\\data\\hidden-conc-hypg\\rr8_volumn'
...
PreConcept = torch.from_numpy(np.load(r'D:\data\hidden-conc-hypg\PreConceptWeight.npy')).to(device)
